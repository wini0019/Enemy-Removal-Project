...
#cover is measured twice in 2009 - 6/23/2009 and 8/12-13/2009, I'm removing 6/23/2009
data.a <- data.a[grep("6/23/2009", data.a$date, invert=T),]
...
data.b <- data.b[!duplicated(data.b),]
write.csv(data.b,file='ER_foundations_master_2014-11-11.csv')
